...
public abstract class Robot extends LinearOpMode {
    ...
    public void initialize() {
        ...
        // HOW DID THIS WORK
        CommandScheduler.getInstance().registerSubsystem(extension, mecanum, pinpoint, pivot, wrist, intake, turret);
    ...
    public Command subPos() {
        return new SubPosCommand(extension, wrist, intake, pivot).alongWith(new InstantCommand(() -> setState(FSMStates.INTAKE)));
    }
    public Command bucketPos() {
        return new ConditionalCommand(LowBucketPosCommand.newWithWristPos(extension, pivot, wrist), new BucketPosCommand(extension, pivot, wrist, turret), lowBucket::get);
    }
