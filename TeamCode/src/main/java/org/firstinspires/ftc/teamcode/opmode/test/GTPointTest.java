...
public class GTPointTest extends Robot {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //                        new BucketPosCommand(extension, pivot, wrist), new
        // GoToPointCommand(mecanum, otos, new Pose2d(-48, 48, Rotation2d.fromDegrees(-45)))),
        //                new GoToPointCommand(mecanum, otos, new Pose2d(-54, 54,
        // Rotation2d.fromDegrees(-45))),
        //                new IntakeSpinCommand(intake,-0.4),
        //                new WaitCommand(1000),
        //                new GoToPointCommand(mecanum, otos, new Pose2d(-54, 48, new
        // Rotation2d(0))).alongWith(new WristCommand(wrist, IntakeConstants.groundPos)),
