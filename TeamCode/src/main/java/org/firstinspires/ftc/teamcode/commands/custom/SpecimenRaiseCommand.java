...
public class SpecimenRaiseCommand extends SequentialCommandGroup {
    ...
    public SpecimenRaiseCommand(
            PivotSubsystem pivot, ExtensionSubsystem extension, WristSubsystem wrist) {
        ...
        addCommands(
                new ParallelCommandGroup(
                        ...
                        new ExtendCommand(extension, SlideConstants.specimenRaisePosition)
                                .withTimeout(
                                        extension.getReasonableExtensionMillis(
                                                SlideConstants.specimenRaisePosition))),
                new InstantCommand(() -> extension.setManualControl(true)),
                new InstantCommand(() -> extension.openloopC(-1.0)),
                new WaitCommand(300),
                new InstantCommand(() -> extension.openloopC(0.0)),
